...
<div class="modal fade" id="staticBackdrop" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="../../controller/addProduct.php" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" pattern="^[a-zA-Z\s]*$" class="form-control" name="title" minlength="10" id="exampleFormControlInput1" placeholder="new Product" required>
                    </div>
                    <div class="mb-2">
                        <label for="exampleFormControlInput1" class="form-label">Sub Title</label>
                        <input type="text" pattern="^[a-zA-Z\s]*$" class="form-control" name="subTitle" id="exampleFormControlInput1" minlength="10" placeholder="more info about the item" required>
                    </div>
                    <div class="mb-2">
                    ...
                    <div class="mb-2">
                        ...
                        <!-- <input type="image" name="link" class="form-control" id="exampleFormControlInput1" required> -->
                        <input type="file" accept="image/png" name="image" required />
                    </div>
